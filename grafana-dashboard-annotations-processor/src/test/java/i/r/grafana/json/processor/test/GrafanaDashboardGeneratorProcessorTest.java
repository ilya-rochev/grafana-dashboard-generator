...
class GrafanaDashboardGeneratorProcessorTest {
    ...
    public void test_dashboard_generate() throws Exception {
        ...
        assertThat(dashboard, hasJsonPath("$.panels[0].targets", hasSize(3)));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[0].targets[0].legendFormat", equalTo("Method 'save' execution time (sec)")));
        assertThat(dashboard, hasJsonPath("$.panels[0].targets[0].range", equalTo(false)));

        assertThat(dashboard, hasJsonPath("$.panels[0].targets[1].expr", equalTo("sum(rate(timer_as_field_seconds_sum{type=\"delete\"}[1m]))/sum(rate(timer_as_field_seconds_count{type=\"delete\"}[1m]))")));
        assertThat(dashboard, hasJsonPath("$.panels[0].targets[1].legendFormat", equalTo("Method 'delete' execution time (sec)")));
        assertThat(dashboard, hasJsonPath("$.panels[0].targets[1].range", equalTo(false)));

        assertThat(dashboard, hasJsonPath("$.panels[0].targets[2].expr", equalTo("sum(rate(timer_as_field_seconds_sum{type=\"get\"}[1m]))/sum(rate(timer_as_field_seconds_count{type=\"get\"}[1m]))")));
        assertThat(dashboard, hasJsonPath("$.panels[0].targets[2].legendFormat", equalTo("Method 'fetch' execution time (sec)")));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[1].targets", hasSize(3)));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[1].targets[0].legendFormat", equalTo("Method 'save' execution time (sec) - annotation")));
        assertThat(dashboard, hasJsonPath("$.panels[1].targets[0].range", equalTo(false)));

        assertThat(dashboard, hasJsonPath("$.panels[1].targets[1].expr", equalTo("sum(rate(timer_as_annotation_seconds_sum{operation=\"delete\"}[1m]))/sum(rate(timer_as_annotation_seconds_count{operation=\"delete\"}[1m]))")));
        assertThat(dashboard, hasJsonPath("$.panels[1].targets[1].legendFormat", equalTo("Method 'delete' execution time (sec) - annotation")));
        assertThat(dashboard, hasJsonPath("$.panels[1].targets[1].range", equalTo(false)));

        assertThat(dashboard, hasJsonPath("$.panels[1].targets[2].expr", equalTo("sum(rate(timer_as_annotation_seconds_sum{operation=\"fetch\"}[1m]))/sum(rate(timer_as_annotation_seconds_count{operation=\"fetch\"}[1m]))")));
        assertThat(dashboard, hasJsonPath("$.panels[1].targets[2].legendFormat", equalTo("Method 'fetch' execution time (sec) - annotation")));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[2].targets[0].expr", equalTo("counter_as_field_total{type=\"saved\"}")));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[2].targets[1].expr", equalTo("counter_as_field_total{type=\"deleted\"}")));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[2].targets[2].expr", equalTo("counter_as_field_total{type=\"fetched\"}")));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[3].targets[0].expr", equalTo("counter_as_annotation_total{operation=\"save\"}")));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[3].targets[1].expr", equalTo("counter_as_annotation_total{operation=\"delete\"}")));
        ...
        assertThat(dashboard, hasJsonPath("$.panels[3].targets[2].expr", equalTo("counter_as_annotation_total{operation=\"fetch\"}")));
